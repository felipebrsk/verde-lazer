                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0)">Pagamento</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-12">
                        <div class="checkout-form">
                            <h2>Faça o seu pagamento aqui</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <label>Linha de endereço 1<span>*</span></label>
                        ...
                        <div class="order-details">
                                ...
                                <div class="content">
                                    <ul>
                                        <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">
                                            Subtotal<span>R${{ number_format(Helper::totalCartPrice(), 2) }}</span></li>
                                        <li class="shipping">
                                            Custos de envio
                                        ...
                                        @if (session('coupon'))
                                            <li class="coupon_price" data-price="{{ session('coupon')['value'] }}">Você
                                                economiza<span>R${{ number_format(session('coupon')['value'], 2) }}</span>
                                            </li>
                                        @endif
                                        @php
                            ...
                            <div class="single-widget">
                                ...
                                <div class="content">
                                    <div class="checkbox">
                                        <form-group>
                                            <input name="payment_method" type="radio" value="cod"> <label> Pagar na entrega
                                            </label><br>
