                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="{{ route('product-grids') }}">Produtos</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                            ...
                            <div class="single-widget range">
                                <h3 class="title">Filtrar por preço</h3>
                            ...
                            <div class="single-widget recent-post">
                                <h3 class="title">Publicados recentemente</h3>
                                ...
                                @foreach ($recent_products as $product)
                                    ...
                                    <div class="single-post first">
                                        <div class="image">
                                            <img src="{{ asset('frontend/products/' . $product->photo) }}" alt="{{ asset('frontend/products/' . $product->photo) }}">
                                        </div>
                                        <div class="content">
                                            <h5><a
                                            ...
                                            @endphp
                                            <p class="price"><del
                                                    class="text-muted">R${{ number_format($product->price, 2) }}</del>
                                                R${{ number_format($org, 2) }} </p>
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="row">
                            @if (count($products) > 0)
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        <a data-toggle="modal" data-target="#{{ $product->id }}"
                                                            title="Visualização rápida" href="#"><i class="fas fa-eye"></i><span>Visualização rápida</span></a>
                                                        <a title="Wishlist"
                                                            href="{{ route('add-to-wishlist', $product->slug) }}"
                                                            class="wishlist" data-id="{{ $product->id }}"><i
                                                                class="far fa-heart"></i><span>Adicionar à lista de desejos</span></a>
                                                    </div>
                                ...
                                @endforeach
                            @else
                                <h4 class="text-warning" style="margin:100px auto;">Não há produtos.</h4>
                            @endif
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            ...
                                            <div class="quickview-stock">
                                                @if ($product->stock > 0)
                                                    <span><i class="far fa-check-circle"></i> {{ $product->stock }} disponível</span>
                                                @else
                                                    <span><i class="far fa-times-circle text-danger"></i>
                                                        {{ $product->stock }} não disponível</span>
                                                @endif
                                            </div>
                                        </div>
                                        @php
