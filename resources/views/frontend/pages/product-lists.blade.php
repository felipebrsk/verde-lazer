                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Produtos</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                                            ...
                                                            <div class="product-action">
                                                                <a data-toggle="modal" data-target="#{{ $product->id }}"
                                                                    title="Visualização rápida" href="#"><i
                                                                        class="fas fa-eye"></i><span>Visualização rápida</span></a>
                                                                <a title="Wishlist"
                                            ...
                                            <div class="col-lg-8 col-md-6 col-12">
                                                <div class="list-content">
                                                    ...
                                                    <a href="javascript:void(0)" class="btn cart"
                                                        data-id="{{ $product->id }}">Comprar agora!</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            <div class="quickview-ratting-wrap">
                                                ...
                                                <a href="#"> ({{ $rate_count }} avaliação de usuário)</a>
                                            </div>
